...
#define TARGET_SCREEN_TILE_OFFSET_X 0//(((SCREEN_WIDTH / TILE_WIDTH) - TARGET_SCREEN_TILE_WIDTH) / 2)
#define TARGET_SCREEN_TILE_OFFSET_Y 0//(((SCREEN_HEIGHT / TILE_HEIGHT) - TARGET_SCREEN_TILE_HEIGHT) / 2)
